...
{messages.message}</div>):(<div class="chat-bubble bg-blue-800 font-medium ">{messages.message}</div>)}
  ...
  return (
    ...
    <div class="drawer-content flex mx-10 my-10 items-left ">
      ...
      <label for="my-drawer-2" class="btn btn-md btn-circle bg-black  drawer-button lg:hidden"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
